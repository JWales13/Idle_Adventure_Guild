...
The remaining Day 4–5 step is authoring the ScriptableObject assets in the Editor, against the field-by-field tables in `Docs/Day04_Asset_Values.md`. Nothing has been *played* until that is done — the logic compiles, but no content exists for it to run on. The 11-step smoke test at the end of that document is the gate.
...
Docs/Day04_Asset_Values.md and the smoke test in that document passed.

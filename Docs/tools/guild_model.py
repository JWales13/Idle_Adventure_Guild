...
below are the ones written on Days 10-11.
...
def content():
    ...
    return {
        ...
        # doubles the archetype's own power and costs five times the hire. The doubling
        # is what keeps rarity visible next to the Training Room's guild-wide +331 at
        # level 40; the 5x is what stops it being a free upgrade.
        "adventurers": {
